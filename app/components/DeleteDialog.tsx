...
export function DeleteDialog({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Dialog */}
      <div className="relative bg-[#262624] border border-[#3a3a3a] rounded-lg shadow-2xl max-w-md w-full mx-4 transform transition-all">
        {/* Header */}
        ...
        <div className="px-6 py-4">
          ...
          <div className="mt-3 p-3 bg-[#171717] border border-[#3a3a3a] rounded-lg">
