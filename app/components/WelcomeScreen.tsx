...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 flex-1 bg-[#191919]">
      {/* Private Chat Toggle - Top Left */}
      <div className="absolute top-3 left-6">
        <div className="relative group">
          <button 
            type="button" 
            onClick={() => alert('Private chat feature coming soon!')}
                    className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-[#353535] transition duration-200 cursor-pointer"
          ...
          <span className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-2 py-1 text-xs text-white bg-gray-800 rounded whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
            ...
            <div className="w-full max-w-2xl mb-8 text-center">
              <h2 className="text-3xl font-medium text-white flex items-center justify-center gap-2">
                <span>Hello, I'm</span>
                <span className="flex items-center">
                  <span className="brand-text lowercase">lumi</span>
                  <div className="h-7 w-7 ml-1 flex items-center justify-center">
                    <img 
                      src="/logo.png" 
                      alt="Lumi Logo" 
                      className="h-6 w-6 object-contain filter-orange"
            ...
            <div className="relative z-0 pb-12">
              ...
              <div className="absolute bottom-2 right-2 flex items-center gap-2">
                ...
                <button
                  type="submit"
                  disabled={isLoading || isStreaming || !message.trim()}
                  className="w-9 h-9 bg-orange-500 rounded-lg flex items-center justify-center hover:bg-orange-600 transition duration-200 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer"
                >
                  <svg
